...
//_______________________________________________________________________________________________________________
    ...
    public LatLng[] getvertices_of_perimeter(){ return this.vertices_of_perimeter;}
    public int getZone_Color(){return this.zone_Color;}
    public PolygonOptions getmPolygonOptions(){return this.mPolygonOptions;}
//_______________________________________________________________________________________________________________

    //set methods
    public void setId(int id) { this.id=id; }
    public void setPins_CurrentZone(Pin[] pins_CurrentZone) { this.pins_CurrentZone=pins_CurrentZone; }
    private void setVertices_of_perimeter(LatLng[] vertices_of_perimeter) { this.vertices_of_perimeter=vertices_of_perimeter; }
    private void setZone_Color(int zone_Color){ this.zone_Color=zone_Color;}
    ...
    public void draw(){
        ...
        if (this.pins_CurrentZone!=null){
            for (Pin p : this.pins_CurrentZone) map.addMarker(p.getPinMarker());
        }
    }
}
